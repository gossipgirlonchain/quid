...
The "Try demo" buttons (nav + hero) open the live app at `https://app.quid.fund` in a new tab. The URL is hard-coded in `Nav.tsx` and `Hero.tsx`; change it there if the app moves.
